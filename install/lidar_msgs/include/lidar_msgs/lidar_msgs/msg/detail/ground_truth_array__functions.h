...
#ifndef LIDAR_MSGS__MSG__DETAIL__GROUND_TRUTH_ARRAY__FUNCTIONS_H_
#define LIDAR_MSGS__MSG__DETAIL__GROUND_TRUTH_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * lidar_msgs__msg__GroundTruthArray__init().
...
/**
 * It calls
 * lidar_msgs__msg__GroundTruthArray__fini()
 ...
 * lidar_msgs__msg__GroundTruthArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * lidar_msgs__msg__GroundTruthArray__Sequence__fini()
 * on the array,
...
#endif  // LIDAR_MSGS__MSG__DETAIL__GROUND_TRUTH_ARRAY__FUNCTIONS_H_
