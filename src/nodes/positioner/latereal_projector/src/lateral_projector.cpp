...
public:
    Projector() 
        ...
        marker_sub_ = this->create_subscription<visualization_msgs::msg::MarkerArray>(
            "yard_description_marker_array", 10, std::bind(&Projector::markerCallback, this, std::placeholders::_1));
        ...
        highlighted_marker_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("highlighted_marker_array", 10);
...
private:
    ...
    std::pair<std::optional<geometry_msgs::msg::Point>, geometry_msgs::msg::Point> findInterpolatedPointOnHighlightedLine(const geometry_msgs::msg::Point& gnss_point) {
        if (!markers_) return {std::nullopt, {}};
    ...
    void publishTrackLines() {
        visualization_msgs::msg::MarkerArray highlighted_markers;
        ...
        for (auto& marker : markers_->markers) {
            ...
            highlighted_markers.markers.push_back(marker);
        }

        highlighted_marker_pub_->publish(highlighted_markers);
    }
